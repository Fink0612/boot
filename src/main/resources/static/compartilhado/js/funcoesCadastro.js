...
function salvarCadastroUsuario(tipoForm) {
	...
	//----------------------------------------
	if (validacaoOk == 1) {
		var proximoFrame = "../usuarios/interCadastroUsuario";
		var pdAcao = "cadastrarUsuario";
		if (tipoForm == 2) {
			proximoFrame = "../usuarios/interCadastroUsuarioEditar";
			pdAcao = "editarFator";
		}
...
function salvarCadastroAgenda(tipoAteracao) {
	...
	//----------------------------------------
	if (validacaoOk == 1) {
		var proximoFrame = "../agendas/interCadastroAgenda";
		if (tipoAteracao == 2) {
			proximoFrame = "../agendas/interCadastroAgendaEditar";
		}
...
function salvarUsuariosAgenda() {
	var proximoFrame = "../agendas/interAgendaUsuarios";
...
function salvarCadastroFator(tipoForm) {
	...
	//----------------------------------------
	if (validacaoOk == 1) {
		var proximoFrame = "../fatores/interCadastroFator";
		var pdAcao = "cadastrarFator";
		if (tipoForm == 2) {
			proximoFrame = "../fatores/interCadastroFatorEditar";
			pdAcao = "editarFator";
		}
		document.getElementById("pdAcao").value = pdAcao;
...
function salvarPareceresFatores() {
	...
	var proximoFrame = "../pareceres/interPareceresFatores";
