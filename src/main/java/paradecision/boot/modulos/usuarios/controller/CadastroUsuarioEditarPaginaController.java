...
import paradecision.boot.modulos.usuarios.service.pagina.CadastroUsuarioEditarPaginaService;

/** Adaptador MVC: recebe HTTP, delega ao serviço e escolhe a view. */
@Controller
public class CadastroUsuarioEditarPaginaController {
  private final CadastroUsuarioEditarPaginaService service;

  public CadastroUsuarioEditarPaginaController(CadastroUsuarioEditarPaginaService service) {
    this.service = service;
  }

  @RequestMapping(
      value = "/usuarios/CadastroUsuarioEditar",
  ...
  public String exibir(HttpServletRequest request, Model model) {
    ...
    return "usuarios/CadastroUsuarioEditar";
  }
}
