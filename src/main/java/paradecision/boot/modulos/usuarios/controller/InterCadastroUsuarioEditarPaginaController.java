...
public class InterCadastroUsuarioEditarPaginaController {
  ...
  public InterCadastroUsuarioEditarPaginaController(
      InterCadastroUsuarioEditarPaginaService service) {
    this.service = service;
  }

  @RequestMapping(
      value = "/usuarios/interCadastroUsuarioEditar",
  ...
  public String exibir(HttpServletRequest request, Model model) {
    ...
    return "usuarios/interCadastroUsuarioEditar";
  }
}
