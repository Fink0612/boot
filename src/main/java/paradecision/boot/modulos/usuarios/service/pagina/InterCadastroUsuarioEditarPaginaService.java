...
public class InterCadastroUsuarioEditarPaginaService {
  ...
  public Map<String, Object> preparar(DadosFormulario formulario) {
    ...
    String okMetodo = "";
    String u_A02_CODIGO = formulario.valor("u_A02_CODIGO");
    ...
    okMetodo = usuarioService.updateUsuario(oUsuarioModel);
    if (oUsuarioModel.getA02_codigo() != 0) {
      ...
      okMetodo = empresaUsuarioPerfilService.updateEmpresaUsuarioPerfil(oEmpresaUsuarioPerfilModel);
    }
