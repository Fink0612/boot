...
public class InterPareceresFatoresPaginaController {
  ...
  public InterPareceresFatoresPaginaController(InterPareceresFatoresPaginaService service) {
    this.service = service;
  }

  @RequestMapping(
      value = "/pareceres/interPareceresFatores",
  ...
  public String exibir(HttpServletRequest request, Model model) {
    ...
    return "pareceres/interPareceresFatores";
  }
}
