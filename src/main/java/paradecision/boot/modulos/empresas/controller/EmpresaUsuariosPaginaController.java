...
import paradecision.boot.modulos.empresas.service.pagina.EmpresaUsuariosPaginaService;

/** Adaptador MVC: recebe HTTP, delega ao serviço e escolhe a view. */
@Controller
public class EmpresaUsuariosPaginaController {
  private final EmpresaUsuariosPaginaService service;

  public EmpresaUsuariosPaginaController(EmpresaUsuariosPaginaService service) {
    this.service = service;
  }

  @RequestMapping(
      value = "/empresas/EmpresaUsuarios",
  ...
  public String exibir(HttpServletRequest request, Model model) {
    ...
    return "empresas/EmpresaUsuarios";
  }
}
