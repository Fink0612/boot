...
public class CadastroFatorEditarPaginaController {
  ...
  public CadastroFatorEditarPaginaController(CadastroFatorEditarPaginaService service) {
    this.service = service;
  }

  @RequestMapping(
      value = "/fatores/CadastroFatorEditar",
  ...
  public String exibir(HttpServletRequest request, Model model) {
    ...
    return "fatores/CadastroFatorEditar";
  }
}
