...
public class AgendaFatoresResultadosPaginaService {
  ...
  public Map<String, Object> preparar(DadosFormulario formulario) {
    ...
    pagina.put(
        ...
        String.valueOf(Math.abs(oAgendaModel.getA04_certeza_resultado())));

    pagina.put(
        "Math_abs_oAgendaModel_A04_contradicao_resultado",
        String.valueOf(Math.abs(oAgendaModel.getA04_contradicao_resultado())));

    pagina.put("oAgendaModel_A04_resultado", String.valueOf(oAgendaModel.getA04_resultado()));
    ...
    if (achouFator == 1) {
      ...
      for (int i = 0; i < arrFatorModel.size(); i++) {
        ...
        linha2.put(
            ...
            String.valueOf(Math.abs(oFatorModel.getA06_certeza_resultante_fator())));

        linha2.put(
            "Math_abs_oFatorModel_A06_contradicao_resultante_fator",
            String.valueOf(Math.abs(oFatorModel.getA06_contradicao_resultante_fator())));

        linha2.put(
            "oFatorModel_A06_resultado_fator",
            String.valueOf(oFatorModel.getA06_resultado_fator()));
      }
    }
