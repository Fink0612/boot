...
import paradecision.boot.modulos.agendas.service.pagina.CadastroAgendaEditarPaginaService;

/** Adaptador MVC: recebe HTTP, delega ao serviço e escolhe a view. */
@Controller
public class CadastroAgendaEditarPaginaController {
  private final CadastroAgendaEditarPaginaService service;

  public CadastroAgendaEditarPaginaController(CadastroAgendaEditarPaginaService service) {
    this.service = service;
  }

  @RequestMapping(
      value = "/agendas/CadastroAgendaEditar",
  ...
  public String exibir(HttpServletRequest request, Model model) {
    ...
    return "agendas/CadastroAgendaEditar";
  }
}
