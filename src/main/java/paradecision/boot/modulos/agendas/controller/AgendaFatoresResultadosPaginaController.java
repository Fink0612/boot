...
import paradecision.boot.modulos.agendas.service.pagina.AgendaFatoresResultadosPaginaService;

/** Adaptador MVC: recebe HTTP, delega ao serviço e escolhe a view. */
@Controller
public class AgendaFatoresResultadosPaginaController {
  private final AgendaFatoresResultadosPaginaService service;

  public AgendaFatoresResultadosPaginaController(AgendaFatoresResultadosPaginaService service) {
    this.service = service;
  }

  @RequestMapping(
      value = "/agendas/AgendaFatoresResultados",
  ...
  public String exibir(HttpServletRequest request, Model model) {
    ...
    return "agendas/AgendaFatoresResultados";
  }
}
