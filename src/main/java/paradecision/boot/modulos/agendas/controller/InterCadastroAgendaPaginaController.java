...
import paradecision.boot.modulos.agendas.service.pagina.InterCadastroAgendaPaginaService;

/** Adaptador MVC: recebe HTTP, delega ao serviço e escolhe a view. */
@Controller
public class InterCadastroAgendaPaginaController {
  private final InterCadastroAgendaPaginaService service;

  public InterCadastroAgendaPaginaController(InterCadastroAgendaPaginaService service) {
    this.service = service;
  }

  @RequestMapping(
      value = "/agendas/interCadastroAgenda",
  ...
  public String exibir(HttpServletRequest request, Model model) {
    ...
    return "agendas/interCadastroAgenda";
  }
}
