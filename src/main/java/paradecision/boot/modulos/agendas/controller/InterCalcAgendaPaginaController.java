...
import paradecision.boot.modulos.agendas.service.pagina.InterCalcAgendaPaginaService;

/** Adaptador MVC: recebe HTTP, delega ao serviço e escolhe a view. */
@Controller
public class InterCalcAgendaPaginaController {
  private final InterCalcAgendaPaginaService service;

  public InterCalcAgendaPaginaController(InterCalcAgendaPaginaService service) {
    this.service = service;
  }

  @RequestMapping(
      value = "/agendas/interCalcAgenda",
  ...
  public String exibir(HttpServletRequest request, Model model) {
    ...
    return "agendas/interCalcAgenda";
  }
}
