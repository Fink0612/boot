...
<td style="text-align:right;"><span class="stlCodForm">CadUsu</span></td>
</tr></table>
...
<span>------------------------------------------------</span><br/>
<input type="button" id="salvar" value="Salvar e Sair" onclick="salvarCadastroUsuario(1)" />
<input type="button" id="cancelar" value="Cancelar e Sair" onclick="cancelarCadastroUsuario(1)" />
<br/>
