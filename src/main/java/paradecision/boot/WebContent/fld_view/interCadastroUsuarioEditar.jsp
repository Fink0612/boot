...
<div style="display:none;"><h2>InterCadastroEditar</h2></div>

<table class="tabTitForm"><tr>
<td>&nbsp;</td>
<td style="text-align:right;"><span class="stlCodForm">intCadUsuEdit</span></td>
</tr></table>
...
<input type="button" value="Voltar" onclick="fecharInterCadastroUsuario(2)" />
</span>
...
<%
String okMetodo = "";
String u_A02_CODIGO = request.getParameter("u_A02_CODIGO");
...
//----------------------------------------------------
if (u_A02_CODIGO == null) u_A02_CODIGO = "";
...
//----------------------------------------------------
long num_a02_codigo = MetodosUteis.retornaLong(u_A02_CODIGO);
oUsuarioModel.setA02_codigo(num_a02_codigo);
...
okMetodo = oUsuarioControl.updateUsuario(oUsuarioModel);
//----------------------------------------------------
if (oUsuarioModel.getA02_codigo() != 0) {
	...
	okMetodo = oEmpresaUsuarioPerfilControl.updateEmpresaUsuarioPerfil(oEmpresaUsuarioPerfilModel);
}
%>
...
if (okMetodo == "OK") {
	...
	//interMensagem.innerHTML = "Usu&aacute;rio alterado com sucesso!";
	...
	var interMensagem = document.getElementById("interMensagem"); 
	interMensagem.innerHTML = "Problemas com a Altera&ccedil;&atilde;o do Usu&aacute;rio!";
