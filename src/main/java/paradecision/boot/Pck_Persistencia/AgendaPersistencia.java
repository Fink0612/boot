...
public class AgendaPersistencia {
	...
	public long insertAgenda(AgendaModel oAgendaModel) {
		...
		sql += "A04_CERTEZA_RESULTADO, A04_CONTRADICAO_RESULTADO, A01_CODIGO, A04_STATUS, A04_DT_CADASTRO) ";
		sql += "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, sysdate())";
		try {
			...
			System.out.println(":: ERRO :: Problemas com a criação de dados no BD...(AP)");
		}
		this.fechaCon();
		return res;
	}
	...
	public String updateAgenda(AgendaModel oAgendaModel) {
		...
		try {
			...
			res = "NOK";
			System.out.println(":: ERRO :: Problemas com a alteração de dados no BD...(AP-U1)");
		}
		this.fechaCon();
		return res;
	}
	...
	public String updateStatusAgenda(AgendaModel oAgendaModel) {
		...
		try {
			...
			msgAction = "NOK";
			System.out.println(":: ERRO :: Problemas com a atualização de dados no BD...(AP-U2)");
		}
		this.fechaCon();
		return msgAction;
	}
